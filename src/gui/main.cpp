...
int main(int, char**)
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        if (ImPlot::BeginPlot("##Rolling", ImVec2(-1,150))) {
            ...
            ImPlot::PlotLine("Mouse X", &rdataX.Data[0].x, &rdataX.Data[0].y, rdataX.Data.size(), 0, 2 * sizeof(float));
            ImPlot::PlotLine("Mouse Y", &rdataY.Data[0].x, &rdataY.Data[0].y, rdataY.Data.size(), 0, 2 * sizeof(float));
            ImPlot::EndPlot();
        }
